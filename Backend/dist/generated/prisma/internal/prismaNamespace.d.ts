...
export declare const ModelName: {
    readonly training_plans: "training_plans";
...
export declare const Training_plansScalarFieldEnum: {
    readonly id: "id";
    readonly user_id: "user_id";
    readonly plan_json: "plan_json";
    readonly plan_text: "plan_text";
...
export declare const User_profilesScalarFieldEnum: {
    ...
    readonly days_per_week: "days_per_week";
    readonly session_length: "session_length";
    readonly equipment: "equipment";
    readonly injuries: "injuries";
    readonly preferred_split: "preferred_split";
